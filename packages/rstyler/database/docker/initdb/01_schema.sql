...
CREATE INDEX fx_rule_bins_indicator_id ON rule_bins(indicator_id);
...
ALTER TABLE rule_bins ADD CONSTRAINT fk_rule_bins_child_rule_id FOREIGN KEY (child_rule_id) REFERENCES rule_bins(child_rule_id);
...
GRANT INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA public TO rstyler_data_steward;
